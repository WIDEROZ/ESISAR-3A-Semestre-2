...
$$\frac{pC_{1}R_{5}(pC_{3}R_{4}+1)}{p(C_{1}+C_{2})(pC_{3}R_{4}R_{5} + R_{4} + R_{5})}$$
...
$$\omega_{0} = \frac{R_{4}}{C_{3}R_{4}R_{5}}$$

$$\frac{p^{2}C_{1}C_{3}R_{5}}{p(C_{1}+C_{2})(pC_{3}R_{5}+1)} = \frac{p^{2}C_{1}C_{3}R_{5}}{p(C_{1}+C_{2})+p^{2}(C_{1}+C_{2})C_{3}R_{5}}$$
