...
float erreurNminus1 = 0;
float commNminus1 = 0;
float commNminus2 = 0;
float ConsFminus1 = 0;

#define mode 2 // 1 pour compensation des pôles; 2 pour placement des pôles
...
void loop() {                // boucle sans fin
 ...
 // Acquisition des entrées analogiques
    ...
    f_cons = conv_ADC2Volt * (float)analog_in1; // Conversion consigne entre 0 et 5V
      ...
      ConsF = 0.0547*f_cons + 0.9435*ConsF;
...
// Calcul et application de la valeur du PWM entre 0 et 255
    ...
    ConsFminus1 = ConsF;
    erreurNminus1 = erreur;
    commNminus2 = commNminus1;
    commNminus1 = Commande;
  }
}
